...
<!-- DataTables CSS with Bootstrap 5 Integration (replaces the old generic CSS) -->
...
<!-- DataTables JS with Bootstrap 5 Integration (replaces the old generic JS) -->
<script src="https://cdn.datatables.net/1.13.7/js/jquery.dataTables.min.js"></script>
<script src="https://cdn.datatables.net/1.13.7/js/dataTables.bootstrap5.min.js"></script>
<!-- DataTables Buttons JS (optional, for exports; keep if needed) -->
